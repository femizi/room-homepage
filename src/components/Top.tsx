    ...
    return (
        <div className="top grid grid-cols-[60%_40%] ">
            <div className='relative'>
                <nav className='absolute font-semibold text-white inset-x-0 top-0  p-8  gap-8 flex'>
                ...
                <div className='w-full'> <img className=' object-cover w-full' src="/images/desktop-image-hero-1.jpg" alt="" /></div>
            </div>
                ...
                <div className='p-24 h-full '>
                    ...
                    <button className='flex align-middle justify-center gap-2 font-semibold tracking-[15px] text-[#454545]'>
                        ...
                        <span className='block -mb-4'>
                            <svg className='-mb-4' width="40" height="12" xmlns="http://www.w3.org/2000/svg"><path d="M34.05 0l5.481 5.527h.008v.008L40 6l-.461.465v.063l-.062-.001L34.049 12l-.662-.668 4.765-4.805H0v-1h38.206l-4.82-4.86L34.05 0z" fill="#000" fill-rule="nonzero" /></svg>
                        </span>
