...
const MobileMenu = ({mobileMenuActive , setMobileMenuActive}) => {
    let active = 'absolute z-20  p-8 pb-12 w-full bg-white flex '
    let inActive = `hidden`
    return (
        <div className={mobileMenuActive ? inActive : active}>
            <div className=''>
            ...
            <nav className='flex md:hidden   font-semibold text-black lowercase     gap-6 '>
            ...
            <div className='h-screen bg-black/40 absolute'>
